...
YOU MUST NOT freely generate your own 4-week allocation; 
instead, select one strategy from the strategy library provided below.

# ============================================================
# STRATEGY LIBRARY (AVAILABLE OPTIONS)
# ============================================================
You must choose exactly ONE of the following patterns for each origin state. As for S2:no control, it means no traffic restriction from that origin state. 
