...
- Output a vector of  28 numeric fractions [f1, f2, f3, f4, f5, f6, f7, f8, f9, f10, f11, f12, f13, f14, f15, f16, f17, f18, f19, f20, f21, f22, f23, f24, f25, f26, f27, f28], each in [0,1].  
- f1, f2, f3, f4, f5, f6, f7, f8, f9, f10, f11, f12, f13, f14, f15, f16, f17, f18,f19,f20,f21,f22,f23,f24,f25,f26,f27,f28 correspond to Day 1, Day 2, Day 3, Day 4, Day 5, Day 6, Day 7, Day 8, Day 9, Day 10, Day 11, Day 12, Day 13, Day 14, Day 15, Day 16, Day 17, Day 18, Day 19, Day 20, Day 21, Day 22, Day 23, Day 24, Day 25, Day 26, Day 27, Day 28 respectively, and the sum of flow at day i is Flow * fi.  
- a low fi means stricter traffic control on day i, while a high fi means relaxed control.
- The 28 fractions (f1+f2+f3+f4+f5+f6+f7+f8+f9+f10+f11+f12+f13+f14+f15+f16+f17+f18+f19+f20+f21+f22+f23+f24+f25+f26+f27+f28) must sum exactly to 1 (use 3-4 decimal precision if needed),  Flow * (f1 + f2 + f3 + f4 + f5 + f6 + f7 + f8 + f9 + f10 + f11 + f12 + f13 + f14+f15+f16+f17+f18+f19+f20+f21+f22+f23+f24+f25+f26+f27+f28) = Flow.
Objective: minimize cumulative confirmed and deceased cases in the current state

## Rules:
- Fractions (f1,f2, f3, f4, f5, f6, f7, f8, f9, f10, f11, f12, f13, f14, f15, f16, f17, f18,f19,f20,f21,f22,f23,f24,f25,f26,f27,f28) must be numeric with exactly 2 entries per origin; sum to 1 (use 3-4 decimals if needed).
...
{{
  "state_name": {{
      "fractions": [f1, f2, f3, f4, f5, f6, f7, f8, f9, f10, f11, f12, f13, f14, f15, f16, f17, f18, f19, f20, f21, f22, f23, f24, f25, f26, f27, f28],    // 28 numbers in [0,1], sum exactly to 1
