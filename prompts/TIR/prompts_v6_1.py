...
3. Choose one pattern: even / strict-first / relaxed-first/ or others to describe the traffic allocation, and explain why (Justify the pattern using infection pressure trends.).
